   ...
   return (
    ...
    <div className="App">
        ...
        <Routes>
          ...
          <Route path="/request" element={<Admin contractAddress={contractAddressTyped} isAdmin={isAdmin} address={address} isGoodNetwork={isGoodNetwork}  isConnected={isConnected} route={'user'}/>}/>
          <Route path="/admin" element={<Admin contractAddress={contractAddressTyped} isAdmin={isAdmin} isGoodNetwork={isGoodNetwork}  isConnected={isConnected} route={'admin'}/>}/>
